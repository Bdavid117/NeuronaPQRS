...
class NvidiaNimClient:
    """Async NVIDIA NIM client — OpenAI-compatible interface."""
    ...
    async def transcribe(
        ...
        """
        Transcribe audio via the /audio/transcriptions endpoint.
        Requires a Whisper-compatible model endpoint; may not be available
        on all NVIDIA NIM deployments.
        """
...
def get_nvidia_nim() -> NvidiaNimClient:
    global _client
    if _client is None:
